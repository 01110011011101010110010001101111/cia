    ...
    for h in range(k):
        ...
        for i in range(0, N, 2):
            ...
            for j in range(0, N, 2):
                ...
                # breakpoint()
                dut.poly_in.value = int(make_num(polynomial_mult(A[h][i:i+2], s[h][j:j+2], size=3), 16))
                ...
                if (i + j + 2 <= N):
                    ...
                    if h == 0 and i == 0:
                        ...
                        dut.e_in.value = int(make_num(e[j:j+2], 16))
                    else:
                        dut.e_in.value = 0

                    dut.b_valid.value = 1
                    dut.b_in.value = int(make_num(b[j+i: j+i+2], 16))
                else:
                    pass
                ...
                if dut.sum_valid.value:
                    ...
                    for l in range(2):
                        ...
                        if (index_sum+l < len(b)):
                            ...
                            print(i+j+l)
                            print(index_sum, l, bit_slice(value_sum, l*16, l*16+15))
                            b[index_sum+l] = bit_slice(value_sum, l*16, l*16+15)
                            b[index_sum+l] %= q
                else:
                    index_sum = dut.sum_idx.value
                    value_sum = 0
